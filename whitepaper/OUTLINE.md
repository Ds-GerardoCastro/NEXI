...
- The provenance chain: paper → atomic principle → consolidation hub → NEXI / cluster.
...
- The two-layer catalog: clusters and patterns.
- NEXI metadata schema, layered card structure, application formats.
- The cluster-as-intelligence-model concept: why complementarity is first-class.
