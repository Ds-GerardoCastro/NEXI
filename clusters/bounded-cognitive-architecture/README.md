...
| Loning et al. 2026 — _Communication Networks of Wild Zebra Finches_ (bioRxiv preprint)                                              | Independent biological evidence for niche-conditional cognitive design — fission-fusion social architecture as response to arid-zone non-stationarity; same signal type takes different function in different contexts.                                                                                |
