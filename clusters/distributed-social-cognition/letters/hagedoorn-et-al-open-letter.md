...
I am writing to introduce the **Nature Intelligence Project**, an independent research initiative I am developing, and to explain what your 2026 paper *Communication networks of wild zebra finches (Taeniopygia castanotis)* (bioRxiv, [10.1101/2025.09.11.675577](https://doi.org/10.1101/2025.09.11.675577)) contributes to it. Your study is the source of **five named patterns** in the project's catalog and the basis of one of its two intelligence-model collections. The translation aims at engineers building artificial intelligence systems, but I want to be sure you can see how I read your work and where the engineering claims sit relative to your findings.
